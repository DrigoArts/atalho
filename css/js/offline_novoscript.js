...
function abrirPopup(titulo) {
    ...
    if (titulo === 'Power Bi') {
        ...
        adicionarListaLinks([
            ...
            { texto: 'Manual do PIX', link: '/pdf2/Treinamento-PAMP-2023.pdf' },
        ...
        adicionarListaLinks([
            { texto: 'CONTAGEM DA VITRINE', link: '/Pdf/vitrine/CONTAGEM%20VITRINE.pdf' },
            { texto: 'CONTROLE DE IMEI', link: '/Pdf/vitrine/controle%20saida%20imei.pdf' },
            { texto: 'N.O.', link: '/Pdf/vitrine/no.pdf' },
            { texto: '# NÃO TROCA TV', link: '/Pdf/vitrine/tv.pdf' },
            { texto: 'NÃO TROCA POSITIVO', link: '/Pdf/vitrine/positivo.pdf' },
            { texto: '# NÃO TROCA ELETROLUX', link: '/Pdf/vitrine/eletrolux.pdf' },
            { texto: '# NÃO TROCA CONSOLE', link: '/Pdf/vitrine/console.pdf' },
            { texto: 'NÃO TROCA DOREL', link: '/Pdf/vitrine/dorel.pdf' },
            //{ texto: 'NÃO TROCA DOREL', link: '' },
            { texto: 'NÃO TROCA APPLE', link: '/Pdf/vitrine/apple.pdf' },
            //{ texto: 'Total', link: '' }
        ]);
    } else if (titulo === 'Acom') {
        adicionarListaLinks([
            { texto: '# Entrega Manual', link: '/Pdf/a.com/Mod.1%20-%20Comprovante%20de%20Entrega%20Manual.pdf' },
            { texto: '# Devolução Manual', link: '/Pdf/a.com/Modelo%2007%20-%20Comprovante%20de%20Devolu%C3%A7%C3%A3o_V01%20(1).pdf' },
        ...
        adicionarListaLinks([
            { texto: 'Check List', link: '/Pdf/caminhao/checklist.pdf' },
